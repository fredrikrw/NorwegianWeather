...
namespace BusinessLogic.UnitTests.Services
{
    public class WeatherReportServiceUnitTests
    {
        ...
        [InlineData(1, TemperatureUnit.Celsius, TemperatureUnit.Kelvin, 274.1)]
        ...
        [InlineData(1, TemperatureUnit.Kelvin, TemperatureUnit.Celsius, -272.1)]
        [InlineData(1, TemperatureUnit.Kelvin, TemperatureUnit.Kelvin, 1)]
        [InlineData(1, TemperatureUnit.Kelvin, TemperatureUnit.Fahrenheit, -457.8)]
